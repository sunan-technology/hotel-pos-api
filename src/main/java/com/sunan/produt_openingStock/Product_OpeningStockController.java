...
public class Product_OpeningStockController {

	private static final Logger logger = LoggerFactory.getLogger(Product_OpeningStockController.class);

	@Autowired
	private Product_OpeningStockService productOpeningStockService;
	...
	@PostMapping
	public ResponseEntity<?> save(@RequestBody Product_OpeningStockDto productOpeningStockDto) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> update(@RequestBody Product_OpeningStockDto productOpeningStockDto, @PathVariable int id) {
